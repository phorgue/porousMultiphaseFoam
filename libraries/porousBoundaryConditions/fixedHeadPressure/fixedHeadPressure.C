...
:
    ...
    hUnsaturated_(dict.lookupOrDefault<scalar>("hUnsaturated",-1))
{
}
...
:
    ...
    hUnsaturated_(ptf.hUnsaturated_)
{}
...
void Foam::fixedHeadPressure::write(Ostream& os) const
{
    ...
    // potential_.writeEntry("potential", os);
    // hUnsaturated_.writeEntry("hUnsaturated", os);
    writeEntry("value", os);
}
