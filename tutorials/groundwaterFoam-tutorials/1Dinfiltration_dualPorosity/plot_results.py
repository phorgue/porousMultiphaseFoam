...
plt.plot(data_metis1f[:,1]*0.025, data_metis1f[:,0], 'b--', label='T=0.01 day')
plt.plot(data4[:,1], data4[:,0], 'r-', label='T=0.04 day')
plt.plot(data_metis4f[:,1]*0.025, data_metis4f[:,0], 'r--', label='T=0.04 day')
plt.plot(data8[:,1], data8[:,0], 'g-', label='T=0.08 day')
plt.plot(data_metis8f[:,1]*0.025, data_metis8f[:,0], 'g--', label='T=0.08 day')
ax1.legend()
...
plt.plot(data_metis1m[:,1]*0.475, data_metis1m[:,0], 'b--', label='T=0.01 day')
plt.plot(data4[:,2], data4[:,0], 'r-', label='T=0.04 jour')
plt.plot(data_metis4m[:,1]*0.475, data_metis4m[:,0], 'r--', label='T=0.04 day')
plt.plot(data8[:,2], data8[:,0], 'g-', label='T=0.08 jour')
plt.plot(data_metis8m[:,1]*0.475, data_metis8m[:,0], 'g--', label='T=0.08 day')
ax2.legend()
