...
plot "sets/10000/acrossFlow_Sb.gplt"  using (1-$1):2 every 15 title "t = 10000s " ps 0.75, \
     "analytical/case2/10000s"  using 1:2 with lines title "",\
     "sets/20000/acrossFlow_Sb.gplt" using (1-$1):2 every 15 title "t = 20000s" ps 0.75, \
     "analytical/case2/20000s" using 1:2 with lines title "",\
     "sets/30000/acrossFlow_Sb.gplt" using (1-$1):2 every 15 title "t = 30000s" ps 0.75, \
